...
$("h4:last").css("font-size", "4rem");
$("h4").filter(":last").css("font-size", "4rem");

// h4 중 다섯번쨰 요소의 텍스트를 '테스트-5'로 변경
// 인덱스니까 4!
$("h4").eq(4).text("테스트-5");
...
// 클래스 선택자 : test를 선택해서 짝수 인덱스 요소만 배경색상 : hotpink, 글자색 : white
$(".test").even().css({ "background-color": "hotpink", color: "white" });

// h4 중 클래스 선택자 test가 아닌 요소를 선택해서 배경색상 : chocolate, 글자색 : white
...
// .wrap인 요소의 모든 하위 요소 중 sapn 태그의 style5를 적용
...
$(".wrap2 h2").nextUntil().css("border", "dashed");
